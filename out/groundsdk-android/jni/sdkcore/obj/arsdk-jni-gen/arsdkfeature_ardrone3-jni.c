...
static struct {
	...
	jmethodID jmid_HeadingLockedStateChanged;
...
Java_com_parrot_drone_sdkcore_arsdk_ArsdkFeatureArdrone3_00024PilotingState_nativeClassInit(JNIEnv *env, jclass jcls) {
	...
	s_cb_ardrone3_PilotingState_cache.jmid_HeadingLockedStateChanged = (*env)->GetStaticMethodID(env, jcls, "headinglockedstatechanged", "(Lcom/parrot/drone/sdkcore/arsdk/ArsdkFeatureArdrone3$PilotingState$Callback;I)V");
}
...
static int evt_ardrone3_PilotingState_HeadingLockedStateChanged(JNIEnv *env, jclass clazz, struct arsdk_cmd *cmd, jobject callback) {
	int32_t state;
	int res = arsdk_cmd_dec_Ardrone3_PilotingState_HeadingLockedStateChanged(cmd, &state);
	if (res < 0)
		return res;
	(*env)->CallStaticVoidMethod(env, clazz, s_cb_ardrone3_PilotingState_cache.jmid_HeadingLockedStateChanged, callback, (jint)state);
	return 0;
}
...
Java_com_parrot_drone_sdkcore_arsdk_ArsdkFeatureArdrone3_00024PilotingState_nativeDecode(JNIEnv *env, jclass jcls, jlong nativeCmd, jobject callback) {
	...
	switch(cmd->cmd_id) {
		...
		case 23: return evt_ardrone3_PilotingState_HeadingLockedStateChanged(env, jcls, cmd, callback);
	}
	return -1;
}
