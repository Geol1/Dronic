...
public class ArsdkFeatureDebug {
    ...
    /** Uid of tag_notify event. */;
    public static final int TAG_NOTIFY_UID = 0x0005;
    ...
    public interface Callback {
         ...
         * 
         * @param id: id of debug tag as generated by the drone
         */
        public default void onTagNotify(String id) {}
    }
    ...
    private static void tagNotify(Callback cb, String id) {
        try {
            cb.onTagNotify(id);
        } catch (ArsdkCommand.RejectedEventException e) {
            ULog.e(TAG, "Rejected event: debug.tag_notify [id: " + id + "]", e);
        }
    }
     ...
     * 
     * @param value: tag value (single line).
     */
    public static ArsdkCommand encodeTag(String value) {
        ArsdkCommand cmd = ArsdkCommand.Pool.DEFAULT.obtain();
        nativeEncodeTag(cmd.getNativePtr(), value);
        return cmd;
    }
    ...
    private static native int nativeEncodeTag(long nativeCmd, String value);
}
